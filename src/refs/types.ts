// Note:
// this file includes struct types as well.
// However implementation for generating these structs from rust-ffi is present in the RustParser class
// We might want to consider that instead of these
...
export const allocCString = (str: any) => ref.allocCString(str);

export const allocAuthReq = (req: any) => ref.alloc(AuthReq, req);

export const allocContainerReq = (req: any) => ref.alloc(ContainersReq, req);

export const allocSharedMdataReq = (req: any) => ref.alloc(ShareMDataReq, req);
